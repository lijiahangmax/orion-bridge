...
public class UserManagerController {
    ...
    public List<AuthorizedDeviceVO> getAuthorizedDevices(@RequestParam Long id) {
    ...
    public List<LoginHistoryVO> getLoginHistory(@RequestParam Long id, @RequestParam Integer limit) {
